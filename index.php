...
<!--<div id="online">
    <a href="/webim/client.php?locale=ru&amp;style=original" target="_blank" onclick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open('/webim/client.php?locale=ru&amp;style=original&amp;url='+escape(document.location.href)+'&amp;referrer='+escape(document.referrer), 'webim', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><img src="/webim/b.php?i=simple&amp;lang=ru" border="0" width="200" height="55" alt=""/></a>
</div>-->

<div id="main_formular">
    <input type="button" value="Образцы формуляров" onclick="location.href='http://10.16.48.22/support/formular.html'">
</div>
...
<div id="footer">
	<p id="ssilky">		
        ...
        <a href="http://10.16.48.22/udo" target="_blank">|  УДО |</a>
		...
		<a href="http://10.16.48.28" target="_blank">|  ГИС ПС КНБ РК |</a>
	</p>
	<?php $date = date ('Y');?>
	<span class="copyright">ГТО &copy 2015-<?php echo $date; ?> г.</span>
</div>
